...
<script>
import PopupLeft from '@/pages/custom-module/ordinary-form/components/popup-left'
import PopupMiddle from '@/pages/custom-module/ordinary-form/components/popup-middle'
import PopupRight from '@/pages/custom-module/ordinary-form/components/popup-right'
export default {
  name: 'Popup',
  components: {
